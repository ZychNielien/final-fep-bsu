...
<head>
    <!-- TITLE WEB PAGE -->
    <title>Faculty Development Plan Report</title>
...
<section class="contentContainer">
    <div class="d-flex justify-content-end mx-5">
        <button type="button" id="printButton" class="btn btn-success">Print
            Content</button>
    </div>
    <div class="container ">
        <?php
        ...
        <div class="d-flex flex-column align-items-start justify-content-md-start bg-white p-2 rounded" id="planReport">
            <?php
                ...
                while ($peertopeerRow = mysqli_fetch_assoc($peertopeerSQL_query)) {
                    ...
                    <div class="w-100  p-0">
                        <div class="d-flex justify-content-between border w-100 p-2">
                            <div class="px-1 text-center">Faculty Name</div>
                            <div class="text-center fw-bold text-uppercase">
                                <?php echo $userName; ?>
                            </div>
                            <div class="px-1 text-center">Semester</div>
                            <div class="px-1 text-center  fw-bold">
                                <?php echo $selectedSemester; ?>
                            </div>
                            <div class="px-1 text-center">Academic Year</div>
                            <div class="px-1 text-center  fw-bold"><?php echo $selectedAcademicYear; ?></div>
                        </div>
                    </div>

                    <div class="border border-1 w-100">
                        <h4 class="fw-bold text-center p-2">Faculty Peer to Peer Evaluation Instrument for Faculty Development
                        </h4>
...
<script>
    $(document).ready(function () {
        // jQuery event for print button
        $('#printButton').click(function () {
            var printContent = $('#planReport').html(); // Get the content to print
            var newWindow = window.open('', '', 'height=600,width=800'); // Open a new window

            // Write the content of the print window
            newWindow.document.write('<html><head><title>Print</title>');
            newWindow.document.write('<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css">');
            newWindow.document.write('</head><body>');
            newWindow.document.write(printContent); // Write the content to the new window
            ...
            setTimeout(function () {
                newWindow.print(); // Open the print dialog after a short delay
