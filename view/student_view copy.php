  ...
  <style>
    ...
    @media (max-width: 576px) {
      ...
      .cics-logo {
        width: 40px;
        height: 40px;
        /* Further shrink images for smaller screens */
      }
      ...
      .name-container {
        flex-direction: column;
        /* Stack the name vertically on smaller screens */
        text-align: center;
      }
      ...
      .form-control {
        width: 100%;
        /* Ensure inputs take full width on small screens */
      }

      label {
        margin-bottom: 0.5rem;
        /* Add space below labels on smaller screens */
      }
    }
  </style>
...
<body>
  ...
  <!-- START NAVBAR -->
  <nav class="navbar bg-danger d-flex flex-row align-items-center justify-content-between p-3 shadow">
    <div>
      <img src="../public/picture/bsu.png" alt="BSU Logo" class="img-fluid bsu-logo" />
    </div>
    <div>
      <h4 class="text-white portal-title m-0">FACULTY EVALUATION PORTAL</h4>
    </div>
    <div>
      <img src="../public/picture/cics.png" alt="CICS Logo" class="img-fluid cics-logo" />
    </div>
  </nav>
  <!-- END NAVBAR -->
  <!-- START PROFILE -->

  <div class="p-3 d-flex align-items-center justify-content-between bg-light shadow">
    <div class="d-flex align-items-center flex-wrap user-container">
      <div class="border p-2 bg-light">
        <img src="../public/picture/user.jpg" alt="User Image" class="img-fluid user-img" />
      </div>
      <div class="px-3 name-container d-flex flex-row">
        <h2 id="lastname" class="mb-0"></h2>
        <h2 id="firstname" class="mb-0 px-2"></h2>
      </div>
  ...
  <div class=" bg-danger p-2 d-flex justify-content-between shadow">
    <div>
  ...
  <!-- START SECOND NAVBAR -->
  <div class="bg-light p-4 d-flex justify-content-around shadow flex-wrap">
    <div class="mb-3">
      <button type="button" id="enroll-btn" class="btn btn-success d-flex align-items-center"
        ...
        <h2 class="m-0"><i class="fa-solid fa-desktop"></i></h2>
        <h6 style="font-family: monospace;" class="px-2 m-0 text-center">Online Registration<br>for <span
            id="getSem2"></span> Semester</h6>
      </button>
    </div>

    <div id="UpdateYearOrSem" class="mb-3">
      <button class="btn btn-success d-flex align-items-center" id="UpdateYS">
        <h2 class="m-0"><i class="fa-solid fa-user-pen"></i></h2>
        <h6 style="font-family: monospace;" class="px-2 m-0 text-center">Update My Status</h6>
      </button>
    </div>

    <div id="major" class="mb-3">
      <button class="btn btn-success d-flex align-items-center" data-bs-target="#major_modal" data-bs-toggle="modal">
        <h2 class="m-0"><i class="fa-solid fa-graduation-cap"></i></h2>
        <h6 style="font-family: monospace;" class="px-2 m-0 text-center">Choose A Major</h6>
      </button>
    </div>
  ...
  <div class="bg-light shadow" style="height: auto; min-height: 40vh">
          ...
          <div id="container" class="">
            <form id="multi-step-form" method="POST" action="../controller/criteria.php">
                    ...
                    <tr>
                      <th style="color: #000 !important;">
                        <div class="d-flex flex-column flex-sm-row align-items-center">
                          <label for="courseInput" class="mr-2 mb-0">Faculty Name:</label>
                      ...
                      <th style="color: #000 !important;">
                        <div class="d-flex flex-column flex-sm-row align-items-center">
                          <label for="academic" class="mr-2 mb-0">Academic Year:</label>
                          <input type="text" id="academic" name="academic_year" class="form-control no-border" readonly
                            value="<?php echo $AYS['academic_year'] ?>" style="flex: 1;">
                        </div>
                      </th>
                    </tr>
                  </thead>
              ...
              <div class="navigation-buttons p-1">
                ...
                <button type="button" class="btn btn-secondary prev-step mx-2" style="display: none;">Previous</button>
