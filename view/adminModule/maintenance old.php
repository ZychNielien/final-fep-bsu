  ...
  <div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade show active" id="AddStudent" role="tabpanel" aria-labelledby="AddStudent-tab">
      <div class="container p-2">
        ...
        <!-- START TABLE -->
        <table id="student_table" class="table table-striped table-bordered text-center mt-5"
            ...
            if (mysqli_num_rows($query_run_st) > 0) {
              while ($row = mysqli_fetch_assoc($query_run_st)) {
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" id="<?php echo $row['sr_code'] ?>" class="btn btn-primary edit-st"
                      data-bs-toggle="modal" data-bs-target="#editstudent">Edit</button>
                    <button type="button" id="<?php echo $row['sr_code'] ?>"
                      class="btn btn-danger delete-st">Delete</button>
                  </td>
                </tr>
                <?php
              }
                ...
                <form action="../../controller/updateSRCst.php" method="POST">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col">
                      ...
                      <input type="text" name="middlename" id="middlename2" class="form-control"
                        placeholder="Enter middel name">
                    </div>
                  </div>
                  <div class="row mb-3">
